...
CREATE TABLE "proof_lines" (
  ...
  CONSTRAINT "fk_proof_lines_definition_id_definitions" FOREIGN KEY ("definition_id") REFERENCES "definitions" ("id") ON UPDATE NO ACTION ON DELETE SET NULL,
...
-- Create index "ix_proof_lines_definition_id" to table: "proof_lines"
CREATE INDEX "ix_proof_lines_definition_id" ON "proof_lines" ("definition_id");
